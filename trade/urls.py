...
from trade.views import ItemDetailView, ItemListView, payment_session, create_pre_order, OrderCreateView
...
urlpatterns = [
    ...
    path('pre_order/', OrderCreateView.as_view(), name='order_create')
]
